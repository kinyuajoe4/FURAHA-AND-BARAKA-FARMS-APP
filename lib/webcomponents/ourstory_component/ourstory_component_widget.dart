...
import 'ourstory_component_model.dart';
export 'ourstory_component_model.dart';

class OurstoryComponentWidget extends StatefulWidget {
  const OurstoryComponentWidget({super.key});

  @override
  State<OurstoryComponentWidget> createState() =>
      _OurstoryComponentWidgetState();
}

class _OurstoryComponentWidgetState extends State<OurstoryComponentWidget>
    with TickerProviderStateMixin {
  late OurstoryComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OurstoryComponentModel());
