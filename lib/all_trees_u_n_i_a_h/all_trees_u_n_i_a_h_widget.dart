...
import 'all_trees_u_n_i_a_h_model.dart';
export 'all_trees_u_n_i_a_h_model.dart';

class AllTreesUNIAHWidget extends StatefulWidget {
  const AllTreesUNIAHWidget({super.key});

  static String routeName = 'AllTreesUNIAH';
  static String routePath = '/allTreesUNIAH';

  @override
  State<AllTreesUNIAHWidget> createState() => _AllTreesUNIAHWidgetState();
}

class _AllTreesUNIAHWidgetState extends State<AllTreesUNIAHWidget> {
  late AllTreesUNIAHModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTreesUNIAHModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord> allTreesUNIAHAllTreesDeliveredRecordList =
            snapshot.data!;
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        valueOrDefault<String>(
                                                          functions
                                                              .sumAllLists(
                                                                  allTreesUNIAHAllTreesDeliveredRecordList
                                                                      .map((e) =>
