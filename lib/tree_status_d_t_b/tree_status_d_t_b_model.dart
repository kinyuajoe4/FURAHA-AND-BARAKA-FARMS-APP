...
import 'tree_status_d_t_b_widget.dart' show TreeStatusDTBWidget;
...
class TreeStatusDTBModel extends FlutterFlowModel<TreeStatusDTBWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in TreeStatusDTB widget.
  List<AllTreesDeliveredRecord>? mainQuery;
  // Stores action output result for [Custom Action - stringToLatLong] action in TreeStatusDTB widget.
