...
import 'tree_status_d_t_b_model.dart';
export 'tree_status_d_t_b_model.dart';

class TreeStatusDTBWidget extends StatefulWidget {
  const TreeStatusDTBWidget({super.key});

  static String routeName = 'TreeStatusDTB';
  static String routePath = '/treeStatusDTB';

  @override
  State<TreeStatusDTBWidget> createState() => _TreeStatusDTBWidgetState();
}

class _TreeStatusDTBWidgetState extends State<TreeStatusDTBWidget>
    with TickerProviderStateMixin {
  late TreeStatusDTBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreeStatusDTBModel());
  ...
  Widget build(BuildContext context) {
    ...
    final chartPieChartColorsList1 = [Color(0xFFCB0A41), Color(0xFF7029CC)];
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord> treeStatusDTBAllTreesDeliveredRecordList =
            snapshot.data!;
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<DistributionPerCountyRecord>
                                      mainCardDistributionPerCountyRecordList =
                                      snapshot.data!;
                                                                ...
                                                                return FlutterFlowDropDown<
                                                                  ...
                                                                  controller: _model
                                                                      ...
                                                                      FormFieldController<
                                                                              String>(
                                                                          null),
                                                                  options: dropDownAllTreesDeliveredRecordList
                                                                      .map((e) =>
                                                                          e.institution)
                                                                      .toList(),
                                                                  onChanged: (val) =>
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'An overview of species distribution ',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                                    ...
                                                                    return FlutterFlowDataTable<
                                                                      ...
                                                                      dataRowBuilder: (alltreesDelItem,
                                                                        ...
                                                                        cells: [
                                                                          ...
                                                                          Text(
                                                                            alltreesDelItem.numberOfTreesDelivered.toString(),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                  letterSpacing: 0.0,
                                                                                  useGoogleFonts: !FlutterFlowTheme.of(context).bodyMediumIsCustom,
                                                      ...
                                                      children: [
                                                        ...
                                                        StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            List<DistributionPerCountyRecord>
                                                                dataTableDistributionPerCountyRecordList =
                                                                snapshot.data!;
                                                            if (dataTableDistributionPerCountyRecordList
                                                                .isEmpty) {
                                                              return EmptyWidget();
                                                            }
                                                            ...
                                                            return SingleChildScrollView(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  rows: dataTableDistributionPerCountyRecordList
                                                                      .mapIndexed((dataTableIndex, dataTableDistributionPerCountyRecord) => [
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dataTableDistributionPerCountyRecord.county,
                                                                                'not set',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                            ...
                                                                            AlignedTooltip(
                                                                              content: Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  'Total Trees Planted: ${dataTableDistributionPerCountyRecord.totalTrees.toString()}',
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  formatNumber(
                                                                                    dataTableDistributionPerCountyRecord.noOfInsitutions,
                                                                            ...
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dataTableDistributionPerCountyRecord.monitoredInsitutions.toString(),
                                                                                '30',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                            ...
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dataTableDistributionPerCountyRecord.totalTrees.toString(),
                                                                                '30',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                            ...
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dataTableDistributionPerCountyRecord.monitoredTrees.toString(),
                                                                                '30',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                            ...
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                valueOrDefault<double>(
                                                                                          dataTableDistributionPerCountyRecord.phase,
                                                                                          30.0,
                                                                                        ) ==
                                                                                        1.0
                                                                                    ? '1 & 2'
