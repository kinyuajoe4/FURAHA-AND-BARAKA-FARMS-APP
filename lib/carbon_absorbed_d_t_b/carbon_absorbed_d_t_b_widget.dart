...
import 'carbon_absorbed_d_t_b_model.dart';
export 'carbon_absorbed_d_t_b_model.dart';

class CarbonAbsorbedDTBWidget extends StatefulWidget {
  const CarbonAbsorbedDTBWidget({super.key});

  static String routeName = 'CarbonAbsorbedDTB';
  static String routePath = '/carbonAbsorbedDTB';

  @override
  State<CarbonAbsorbedDTBWidget> createState() =>
      _CarbonAbsorbedDTBWidgetState();
}

class _CarbonAbsorbedDTBWidgetState extends State<CarbonAbsorbedDTBWidget> {
  late CarbonAbsorbedDTBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarbonAbsorbedDTBModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.y2025 = true;
      _model.carbonAbsorbed = 90913.0;
      _model.totalTreesplanted = 870180.0;
      safeSetState(() {});
    });
    ...
    return StreamBuilder<List<DistributionPerCountyRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DistributionPerCountyRecord>
            carbonAbsorbedDTBDistributionPerCountyRecordList = snapshot.data!;
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Equivalent to  2100 cars taken off the road for a year',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                                        .override(
                                          ...
                                          return Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    '${functions.sumAllLists(containerTotalTreesPerSpeciesRecordList.map((e) => e.totalCarbonSequestred).toList()).toString()} Kgs',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodySmall
                                                        .override(
                                            ...
                                            children: [
                                              Text(
                                                valueOrDefault<String>(
                                                  functions
                                                      .sumAllLists(
                                                          carbonAbsorbedDTBDistributionPerCountyRecordList
                                                              .map((e) =>
                                                                  e.totalTrees)
                                                              .toList())
                                                      ?.toString(),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Equivalent to  2110 cars taken off the road for a year',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                                        .override(
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                functions.sumAllLists(carbonAbsorbedDTBDistributionPerCountyRecordList.map((e) => e.totalTrees).toList())?.toString(),
                                                                                '0',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              _model.carbonAbsorbed =
                                                                  functions.sumAllLists(containerTotalTreesPerSpeciesRecordList
                                                                      .map((e) =>
                                                                          e.totalCarbonSequestred)
                                                                      .toList())!;
                                                              safeSetState(
