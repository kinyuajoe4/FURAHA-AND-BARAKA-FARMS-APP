...
import 'carbon_absorbed_absa_life_assurance_kenya_model.dart';
export 'carbon_absorbed_absa_life_assurance_kenya_model.dart';

class CarbonAbsorbedAbsaLifeAssuranceKenyaWidget extends StatefulWidget {
  const CarbonAbsorbedAbsaLifeAssuranceKenyaWidget({super.key});

  static String routeName = 'CarbonAbsorbedAbsaLifeAssuranceKenya';
  static String routePath = '/carbonAbsorbedAbsaLifeAssuranceKenya';

  @override
  State<CarbonAbsorbedAbsaLifeAssuranceKenyaWidget> createState() =>
      _CarbonAbsorbedAbsaLifeAssuranceKenyaWidgetState();
}

class _CarbonAbsorbedAbsaLifeAssuranceKenyaWidgetState
    extends State<CarbonAbsorbedAbsaLifeAssuranceKenyaWidget> {
  late CarbonAbsorbedAbsaLifeAssuranceKenyaModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CarbonAbsorbedAbsaLifeAssuranceKenyaModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            carbonAbsorbedAbsaLifeAssuranceKenyaAllTreesDeliveredRecordList =
            snapshot.data!;
                                                        ...
                                                        onTap: () async {
                                                          _model.carbonAbsorbed =
                                                            ...
                                                            (math.pow(
                                                                    ...
                                                                    44 /
                                                                    12 *
                                                                    (functions.sumAllLists(carbonAbsorbedAbsaLifeAssuranceKenyaAllTreesDeliveredRecordList
                                                                        .map((e) =>
