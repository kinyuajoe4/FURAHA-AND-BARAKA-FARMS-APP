...
import 'all_insitutions_model.dart';
export 'all_insitutions_model.dart';

class AllInsitutionsWidget extends StatefulWidget {
  const AllInsitutionsWidget({
    super.key,
    this.searchname,
  ...
  static String routeName = 'allInsitutions';
  static String routePath = '/allInsitutions';

  @override
  State<AllInsitutionsWidget> createState() => _AllInsitutionsWidgetState();
}

class _AllInsitutionsWidgetState extends State<AllInsitutionsWidget> {
  late AllInsitutionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllInsitutionsModel());
                                    ...
                                    return Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          await actions.generateHybridExcel(
                                            containerFieldsRecordList
                                                .map((e) =>
                    ...
                    child: StreamBuilder<List<FieldsRecord>>(
                      stream: queryFieldsRecord(
                        queryBuilder: (fieldsRecord) =>
                          ...
                          Filter(
                            'PlanterCompany',
                            isEqualTo: FFAppState().planterCompanyFilter,
                          ),
                        )),
                      ),
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData) {
                          return Image.asset(
                            'projects/furaha-baraka-web-mhfk4u/assets/9e9ds6oi3t0i/furaha02-01.png',
                          );
                        }
                                                              ...
                                                              if (selectedMedia !=
                                                                  ...
                                                                  selectedMedia.every((m) =>
                                                                      validateFileFormat(
                                                                          ...
                                                                          context))) {
                                                                safeSetState(() =>
                                                                    _model.isDataUploading_uploadDataAfwertyIIIEDOPUUUGF =
                                                                        true);
                                                                ...
                                                                if (selectedUploadedFiles
                                                                  ...
                                                                  safeSetState(
                                                                      () {
                                                                    _model.uploadedLocalFile_uploadDataAfwertyIIIEDOPUUUGF =
                                                                        selectedUploadedFiles
                                                                            .first;
                                                                    _model.uploadedFileUrl_uploadDataAfwertyIIIEDOPUUUGF =
                                                                        downloadUrls
                                                                            .first;
                                                                  });
                                                                } else {
                                                                ...
                                                                ...mapToFirestore(
                                                                  {
                                                                    'imagesOverTime':
                                                                        FieldValue
                                                                            .arrayUnion([
                                                                      _model
                                                                          .uploadedFileUrl_uploadDataAfwertyIIIEDOPUUUGF
                                                                    ]),
                                                                  },
                                                                ),
                                                              });
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    if (selectedMedia !=
                                                                        ...
                                                                        selectedMedia.every((m) => validateFileFormat(
                                                                            ...
                                                                            context))) {
                                                                      safeSetState(() =>
                                                                          _model.isDataUploading_uploadDataAfwertyiJJ =
                                                                              true);
                                                                      var selectedUploadedFiles =
                                                                          <FFUploadedFile>[];
                                                                      ...
                                                                      if (selectedUploadedFiles.length ==
                                                                        ...
                                                                        safeSetState(
                                                                            () {
                                                                          _model.uploadedLocalFile_uploadDataAfwertyiJJ =
                                                                              selectedUploadedFiles.first;
                                                                          _model.uploadedFileUrl_uploadDataAfwertyiJJ =
                                                                              downloadUrls.first;
                                                                        });
                                                                      } else {
                                                                        safeSetState(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          TextSpan(
                                                                            text:
                                                                                searchresultsItem.planterCompany,
                                                                            style:
                                                                                TextStyle(
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Theme(
                                                                          ...
                                                                          child:
                                                                              Checkbox(
                                                                            value: _model.checkboxValueMap[searchresultsItem] ??=
                                                                                searchresultsItem.isDTBandKCB,
                                                                            onChanged: searchresultsItem.isDTBandKCB
                                                                                ? null
                                                                                : (newValue) async {
                                                                                    safeSetState(() => _model.checkboxValueMap[searchresultsItem] = newValue!);
                                                                                  },
                                                                            ...
                                                                            activeColor:
                                                                                FlutterFlowTheme.of(context).primary,
                                                                            checkColor: searchresultsItem.isDTBandKCB
                                                                                ? null
