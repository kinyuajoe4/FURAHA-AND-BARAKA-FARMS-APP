...
import '/index.dart';
import 'all_insitutions_widget.dart' show AllInsitutionsWidget;
...
class AllInsitutionsModel extends FlutterFlowModel<AllInsitutionsWidget> {
  ...
  bool isDataUploading_uploadDataAfwertyIIIEDOPUUUGF = false;
  FFUploadedFile uploadedLocalFile_uploadDataAfwertyIIIEDOPUUUGF =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataAfwertyIIIEDOPUUUGF = '';

  bool isDataUploading_uploadDataAfwertyiJJ = false;
  FFUploadedFile uploadedLocalFile_uploadDataAfwertyiJJ =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataAfwertyiJJ = '';

  // State field(s) for Checkbox widget.
  Map<FieldsRecord, bool> checkboxValueMap = {};
  List<FieldsRecord> get checkboxCheckedItems =>
