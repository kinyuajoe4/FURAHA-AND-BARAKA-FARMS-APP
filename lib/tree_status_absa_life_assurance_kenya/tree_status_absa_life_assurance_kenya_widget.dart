...
import 'tree_status_absa_life_assurance_kenya_model.dart';
export 'tree_status_absa_life_assurance_kenya_model.dart';

class TreeStatusAbsaLifeAssuranceKenyaWidget extends StatefulWidget {
  const TreeStatusAbsaLifeAssuranceKenyaWidget({super.key});

  static String routeName = 'TreeStatusAbsaLifeAssuranceKenya';
  static String routePath = '/treeStatusAbsaLifeAssuranceKenya';

  @override
  State<TreeStatusAbsaLifeAssuranceKenyaWidget> createState() =>
      _TreeStatusAbsaLifeAssuranceKenyaWidgetState();
}

class _TreeStatusAbsaLifeAssuranceKenyaWidgetState
    extends State<TreeStatusAbsaLifeAssuranceKenyaWidget>
    with TickerProviderStateMixin {
  late TreeStatusAbsaLifeAssuranceKenyaModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => TreeStatusAbsaLifeAssuranceKenyaModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            treeStatusAbsaLifeAssuranceKenyaAllTreesDeliveredRecordList =
            snapshot.data!;
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      onChanged: (val) async {
                                        safeSetState(() =>
                                            _model.allCountieslistValue = val);
                                        ...
                                        await _model
                                            .institutionsfiltered!.reference
                                            .update(
                                                createDistributionPerCountyRecordData(
                                          totalTrees: functions.sumAllLists(
                                              _model.totaltreespercounty
                                                  ?.map((e) =>
                                                      e.totalTreesPlanted)
                                                  .toList()
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                StreamBuilder<
                                    List<AbsaDIstributionPerCountyRecord>>(
                                  stream: queryAbsaDIstributionPerCountyRecord(
                                    queryBuilder:
                                        (absaDIstributionPerCountyRecord) =>
                                            absaDIstributionPerCountyRecord
                                                .orderBy('totalTrees',
                                                    descending: true),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    List<AbsaDIstributionPerCountyRecord>
                                        dataTableAbsaDIstributionPerCountyRecordList =
                                        snapshot.data!;
                                    if (dataTableAbsaDIstributionPerCountyRecordList
                                        .isEmpty) {
                                      return EmptyWidget();
                                    }
                                          ...
                                          rows:
                                              dataTableAbsaDIstributionPerCountyRecordList
                                                  .mapIndexed((dataTableIndex,
                                                          dataTableAbsaDIstributionPerCountyRecord) =>
                                                      [
                                                        Text(
                                                          valueOrDefault<
                                                              String>(
                                                          ...
                                                          content: Padding(
                                                            padding:
                                                                EdgeInsets.all(
                                                                    4.0),
                                                            child: Text(
                                                              'Total Trees Planted: ${dataTableAbsaDIstributionPerCountyRecord.totalTrees.toString()}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyLarge
                                                                  .override(
