...
import 'all_trees_i_b_e_r_a_f_r_i_c_a_model.dart';
export 'all_trees_i_b_e_r_a_f_r_i_c_a_model.dart';

class AllTreesIBERAFRICAWidget extends StatefulWidget {
  const AllTreesIBERAFRICAWidget({super.key});

  static String routeName = 'allTreesIBERAFRICA';
  static String routePath = '/allTreesIBERAFRICA';

  @override
  State<AllTreesIBERAFRICAWidget> createState() =>
      _AllTreesIBERAFRICAWidgetState();
}

class _AllTreesIBERAFRICAWidgetState extends State<AllTreesIBERAFRICAWidget> {
  late AllTreesIBERAFRICAModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTreesIBERAFRICAModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            allTreesIBERAFRICAAllTreesDeliveredRecordList = snapshot.data!;
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            valueOrDefault<
                                                                String>(
                                                              functions
                                                                  .sumAllLists(allTreesIBERAFRICAAllTreesDeliveredRecordList
                                                                      .map((e) =>
