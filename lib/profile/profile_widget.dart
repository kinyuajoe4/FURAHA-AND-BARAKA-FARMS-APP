      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              Align(
                alignment: AlignmentDirectional(0.0, -4.44),
                child: Container(
                  width: 370.0,
                  height: 2000.0,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                                ...
                                image: DecorationImage(
                                  ...
                                  image: Image.network(
                                    valueOrDefault<String>(
                                      _model.uploadedFileUrl_uploadDataPs,
                                      'picha',
                                    ),
                                  ).image,
                                ),
                              ...
                              child: Visibility(
                                visible: _model.uploadedFileUrl_uploadDataPs ==
                                        null ||
                                    _model.uploadedFileUrl_uploadDataPs == '',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                final selectedMedia =
                                  ...
                                  context: context,
                                  storageFolderPath: 'profilepicsFolder',
                                  maxWidth: 200.00,
                                  maxHeight: 200.00,
                                  imageQuality: 68,
                                  allowPhoto: true,
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataPs = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadDataPs = false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataPs =
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) =>
                                        ...
                                        controller:
                                          ...
                                          _model.userValue ??= valueOrDefault(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await currentUserReference!
                                              ...
                                              photoUrl: _model.uploadedFileUrl_uploadDataPs ==
                                                          null ||
                                                      _model.uploadedFileUrl_uploadDataPs ==
                                                          ''
                                                  ? currentUserPhoto
                                                  : _model
                                                      .uploadedFileUrl_uploadDataPs,
                                              phoneNumber: '',
                                              bio:
                                ...
                                var confirmDialogResponse = await showDialog<
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              'All your infomation will be deleted?'),
                                          actions: [
                                            TextButton(
