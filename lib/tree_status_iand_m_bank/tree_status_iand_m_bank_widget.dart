...
import 'tree_status_iand_m_bank_model.dart';
export 'tree_status_iand_m_bank_model.dart';

class TreeStatusIandMBankWidget extends StatefulWidget {
  const TreeStatusIandMBankWidget({super.key});

  static String routeName = 'TreeStatusIandMBank';
  static String routePath = '/treeStatusIandMBank';

  @override
  State<TreeStatusIandMBankWidget> createState() =>
      _TreeStatusIandMBankWidgetState();
}

class _TreeStatusIandMBankWidgetState extends State<TreeStatusIandMBankWidget>
    with TickerProviderStateMixin {
  late TreeStatusIandMBankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreeStatusIandMBankModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            treeStatusIandMBankAllTreesDeliveredRecordList = snapshot.data!;
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (responsiveVisibility(
                                                        ...
                                                        StreamBuilder<
                                                            List<
                                                                IandMDistributionperCountyRecord>>(
                                                          stream:
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            List<IandMDistributionperCountyRecord>
                                                                dataTableIandMDistributionperCountyRecordList =
                                                                snapshot.data!;
                                                            if (dataTableIandMDistributionperCountyRecordList
                                                                .isEmpty) {
                                                              return EmptyWidget();
                                                            }
                                                            ...
                                                            return SingleChildScrollView(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  rows: dataTableIandMDistributionperCountyRecordList
                                                                      .mapIndexed((dataTableIndex, dataTableIandMDistributionperCountyRecord) => [
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dataTableIandMDistributionperCountyRecord.county,
                                                                                'not set',
                                                                              ),
                                                                            ...
                                                                            Text(
                                                                              formatNumber(
                                                                                dataTableIandMDistributionperCountyRecord.noOfInsitutions,
                                                        ...
                                                        rows:
                                                            dataTableDistributionPerCountyRecordList
                                                                .mapIndexed((dataTableIndex,
                                                                        dataTableDistributionPerCountyRecord) =>
                                                                    [
                                                                      Text(
                                                                        valueOrDefault<
                                                                            String>(
