...
import 'tree_status_d_t_b_copy_model.dart';
export 'tree_status_d_t_b_copy_model.dart';

class TreeStatusDTBCopyWidget extends StatefulWidget {
  const TreeStatusDTBCopyWidget({super.key});

  static String routeName = 'TreeStatusDTBCopy';
  static String routePath = '/treeStatusDTBCopy';

  @override
  State<TreeStatusDTBCopyWidget> createState() =>
      _TreeStatusDTBCopyWidgetState();
}

class _TreeStatusDTBCopyWidgetState extends State<TreeStatusDTBCopyWidget>
    with TickerProviderStateMixin {
  late TreeStatusDTBCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreeStatusDTBCopyModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            treeStatusDTBCopyAllTreesDeliveredRecordList = snapshot.data!;
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                        TreeStatusDTBCopyWidget.routeName);
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    height: 48.0,
                                                                                      ...
                                                                                      child: Text(
                                                                                        valueOrDefault<String>(
                                                                                          (valueOrDefault<double>(
                                                                                                    functions.sumAllLists(mainCardDistributionPerCountyRecordList.map((e) => e.totalTrees).toList()),
                                                                                                    0.0,
                                                                                                  ) -
                                                                                                  9903)
                                                                                              .toString(),
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      valueOrDefault<String>(
                                                                                        functions.sumAllLists(mainCardDistributionPerCountyRecordList.map((e) => e.totalTrees).toList()).toString(),
                                                                                        '0',
                                                                                      ),
                                                                                      textAlign: TextAlign.center,
                                                                                      style: FlutterFlowTheme.of(context).displaySmall.override(
