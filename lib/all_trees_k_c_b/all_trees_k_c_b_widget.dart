...
import 'all_trees_k_c_b_model.dart';
export 'all_trees_k_c_b_model.dart';

class AllTreesKCBWidget extends StatefulWidget {
  const AllTreesKCBWidget({super.key});

  static String routeName = 'AllTreesKCB';
  static String routePath = '/allTreesKCB';

  @override
  State<AllTreesKCBWidget> createState() => _AllTreesKCBWidgetState();
}

class _AllTreesKCBWidgetState extends State<AllTreesKCBWidget>
    with TickerProviderStateMixin {
  late AllTreesKCBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTreesKCBModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord> allTreesKCBAllTreesDeliveredRecordList =
            snapshot.data!;
