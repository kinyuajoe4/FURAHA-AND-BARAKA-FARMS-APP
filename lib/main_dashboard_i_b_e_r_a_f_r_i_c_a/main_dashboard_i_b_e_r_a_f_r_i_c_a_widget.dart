...
import 'main_dashboard_i_b_e_r_a_f_r_i_c_a_model.dart';
export 'main_dashboard_i_b_e_r_a_f_r_i_c_a_model.dart';

class MainDashboardIBERAFRICAWidget extends StatefulWidget {
  const MainDashboardIBERAFRICAWidget({super.key});

  static String routeName = 'mainDashboardIBERAFRICA';
  static String routePath = '/mainDashboardIBERAFRICA';

  @override
  State<MainDashboardIBERAFRICAWidget> createState() =>
      _MainDashboardIBERAFRICAWidgetState();
}

class _MainDashboardIBERAFRICAWidgetState
    extends State<MainDashboardIBERAFRICAWidget> with TickerProviderStateMixin {
  late MainDashboardIBERAFRICAModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainDashboardIBERAFRICAModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            mainDashboardIBERAFRICAAllTreesDeliveredRecordList = snapshot.data!;
                                                                ...
                                                                '${valueOrDefault<String>(
                                                                  formatNumber(
                                                                    (math.pow((math.pow(0.4, 2) * 0.7 * 3.0),
                                                                            ...
                                                                            44 /
                                                                            12 *
                                                                            (functions.sumAllLists(mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList())!)) *
                                                                        11 /
                                                                        1000,
                                                                    formatType:
                                                                        FormatType
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          functions
                                                                              .sumAllLists(mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList())
                                                                              .toString(),
                                                                          '0',
                                                                        ),
                                                                        textAlign:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              functions.summarizeGroupedTotals1(mainCardTotalTreesPerSpeciesRecordList.map((e) => e.treeName).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.treeSpeciesDelivered).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList()).length.toString(),
                                                                              '0',
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                  ...
                                                                  valueOrDefault<
                                                                    ...
                                                                    functions
                                                                        .summarizeGroupedTotals1(
                                                                            ...
                                                                            mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.treeSpeciesDelivered).toList(),
                                                                            mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList())
                                                                        .length
                                                                        .toString(),
                                                                    '0',
                                                                  ),
                                                                    ...
                                                                    .summarizeGroupedTotals1(
                                                                        mainCardTotalTreesPerSpeciesRecordList
                                                                            .map((e) => e
                                                                                .treeName)
                                                                            .toList(),
                                                                        mainDashboardIBERAFRICAAllTreesDeliveredRecordList
                                                                            .map((e) => e
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return CircularPercentIndicator(
                                                                            ...
                                                                            center:
                                                                                Text(
                                                                              valueOrDefault<String>(
                                                                                functions.summarizeGroupedTotals1(containerDistributionPerCountyRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList()).length.toString(),
                                                                                '0',
                                                                              ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final distpercounty = functions.summarizeGroupedTotals1(containerDistributionPerCountyRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList()).toList();
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final distpercounty = functions.summarizeGroupedTotalsValuesOnly(containerDistributionPerCountyRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.county).toList(), mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList()).toList();
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: Padding(
                                                                                          ...
                                                                                          child: Text(
                                                                                            '${valueOrDefault<String>(
                                                                                              functions.sumAllLists(mainDashboardIBERAFRICAAllTreesDeliveredRecordList.map((e) => e.numberOfTreesDelivered).toList()).toString(),
                                                                                              '0',
                                                                                            )} Trees',
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
