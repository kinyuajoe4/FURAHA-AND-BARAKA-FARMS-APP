...
import 'all_trees_d_t_b_model.dart';
export 'all_trees_d_t_b_model.dart';

class AllTreesDTBWidget extends StatefulWidget {
  const AllTreesDTBWidget({super.key});

  static String routeName = 'AllTreesDTB';
  static String routePath = '/allTreesDTB';

  @override
  State<AllTreesDTBWidget> createState() => _AllTreesDTBWidgetState();
}

class _AllTreesDTBWidgetState extends State<AllTreesDTBWidget> {
  late AllTreesDTBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTreesDTBModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(TreeStatusDTBWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 48.0,
