...
import 'add_fields_model.dart';
export 'add_fields_model.dart';

class AddFieldsWidget extends StatefulWidget {
  const AddFieldsWidget({
    super.key,
    this.treesDocument,
    this.seedsperSite,
  });
  ...
  static String routeName = 'addFields';
  static String routePath = '/addFields';

  @override
  State<AddFieldsWidget> createState() => _AddFieldsWidgetState();
}

class _AddFieldsWidgetState extends State<AddFieldsWidget>
    with TickerProviderStateMixin {
  late AddFieldsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFieldsModel());
    ...
    _model.mainPlanterTextController ??= TextEditingController();
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Text(
                          'Add trees in an existing Field?',
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_uploadDataAfTYU =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataAfTYU =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataAfTYU =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataAfTYU =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                                                          ...
                                                          child:
                                                            ...
                                                            image:
                                                              ...
                                                              valueOrDefault<
                                                                  String>(
                                                                _model
                                                                    .uploadedFileUrl_uploadDataAfTYU,
