...
class AccountDeletionWidget extends StatefulWidget {
  ...
  static String routeName = 'AccountDeletion';
  static String routePath = '/accountDeletion';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              wrapWithModel(
                model: _model.requestaccountDeletionModel,
                updateCallback: () => safeSetState(() {}),
                child: RequestaccountDeletionWidget(),
              ),
            ],
          ),
        ),
