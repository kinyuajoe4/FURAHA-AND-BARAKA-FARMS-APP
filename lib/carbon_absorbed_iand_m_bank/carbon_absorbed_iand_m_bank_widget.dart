...
import 'carbon_absorbed_iand_m_bank_model.dart';
export 'carbon_absorbed_iand_m_bank_model.dart';

class CarbonAbsorbedIandMBankWidget extends StatefulWidget {
  const CarbonAbsorbedIandMBankWidget({super.key});

  static String routeName = 'CarbonAbsorbedIandMBank';
  static String routePath = '/carbonAbsorbedIandMBank';

  @override
  State<CarbonAbsorbedIandMBankWidget> createState() =>
      _CarbonAbsorbedIandMBankWidgetState();
}

class _CarbonAbsorbedIandMBankWidgetState
    extends State<CarbonAbsorbedIandMBankWidget> {
  late CarbonAbsorbedIandMBankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarbonAbsorbedIandMBankModel());
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Equivalent to 1 car(s) taken off the road for a year',
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                                  fontFamily:
