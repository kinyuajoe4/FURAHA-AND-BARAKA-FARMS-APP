...
import 'all_trees_iand_m_bank_model.dart';
export 'all_trees_iand_m_bank_model.dart';

class AllTreesIandMBankWidget extends StatefulWidget {
  const AllTreesIandMBankWidget({super.key});

  static String routeName = 'AllTreesIandMBank';
  static String routePath = '/allTreesIandMBank';

  @override
  State<AllTreesIandMBankWidget> createState() =>
      _AllTreesIandMBankWidgetState();
}

class _AllTreesIandMBankWidgetState extends State<AllTreesIandMBankWidget> {
  late AllTreesIandMBankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTreesIandMBankModel());
    ...
    return StreamBuilder<List<AllTreesDeliveredRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllTreesDeliveredRecord>
            allTreesIandMBankAllTreesDeliveredRecordList = snapshot.data!;
                                                              ...
                                                              return FlutterFlowGoogleMap(
                                                                ...
                                                                initialLocation: _model
                                                                    ...
                                                                    LatLng(
                                                                        0.0236,
                                                                        37.9062),
                                                                markers: googleMapFieldsRecordList
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return GestureDetector(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: TappedmapIandMbankWidget(
