...
import 'uploadreceipt_model.dart';
export 'uploadreceipt_model.dart';
...
class UploadreceiptWidget extends StatefulWidget {
  ...
  final SeedsDistributionPerInstitutionRecord? docref;
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  'Upload receipt to confirm successful delivery of seedlings',
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Hero(
                                          ...
                                          child: Image.network(
                                            _model.uploadedFileUrl_uploadData0q,
                                            width: 120.0,
                                            height: 120.0,
                                            fit: BoxFit.cover,
                                          ),
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  final selectedMedia =
                                    ...
                                    context: context,
                                    storageFolderPath: 'deliveryreceipts',
                                    allowPhoto: true,
                                  );
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData0q = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadData0q =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData0q =
