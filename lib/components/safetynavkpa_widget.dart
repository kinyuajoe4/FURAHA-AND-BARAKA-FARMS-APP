...
import 'safetynavkpa_model.dart';
export 'safetynavkpa_model.dart';

class SafetynavkpaWidget extends StatefulWidget {
  const SafetynavkpaWidget({super.key});

  @override
  State<SafetynavkpaWidget> createState() => _SafetynavkpaWidgetState();
}

class _SafetynavkpaWidgetState extends State<SafetynavkpaWidget> {
  late SafetynavkpaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SafetynavkpaModel());
        ...
        child: Column(
          ...
          children: [
            ...
            if (_model.showMini == true)
              wrapWithModel(
                model: _model.safetyMiniNavModel,
                updateCallback: () => safeSetState(() {}),
                child: SafetyMiniNavWidget(),
              ),
