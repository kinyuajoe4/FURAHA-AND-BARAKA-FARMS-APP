...
import 'update_comp_model.dart';
export 'update_comp_model.dart';
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        'Get the latest update to access all the features.',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  await launchURL(
                                      'https://play.google.com/store/apps/details?id=com.company.furahabaraka&pcampaignid=web_share');
                                },
                                text: 'Update',
