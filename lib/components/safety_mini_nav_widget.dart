...
import 'safety_mini_nav_model.dart';
export 'safety_mini_nav_model.dart';

class SafetyMiniNavWidget extends StatefulWidget {
  const SafetyMiniNavWidget({super.key});

  @override
  State<SafetyMiniNavWidget> createState() => _SafetyMiniNavWidgetState();
}

class _SafetyMiniNavWidgetState extends State<SafetyMiniNavWidget> {
  late SafetyMiniNavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SafetyMiniNavModel());
