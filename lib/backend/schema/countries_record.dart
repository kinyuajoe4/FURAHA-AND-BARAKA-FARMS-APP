...
class CountriesRecord extends FirestoreRecord {
  ...
  String get countryNames => _countryNames ?? '';
  bool hasCountryNames() => _countryNames != null;

  void _initializeFields() {
    _countryNames = snapshotData['countryNames'] as String?;
  }
...
class CountriesRecordDocumentEquality implements Equality<CountriesRecord> {
  ...
  bool equals(CountriesRecord? e1, CountriesRecord? e2) {
    return e1?.countryNames == e2?.countryNames;
  }

  @override
  int hash(CountriesRecord? e) => const ListEquality().hash([e?.countryNames]);
