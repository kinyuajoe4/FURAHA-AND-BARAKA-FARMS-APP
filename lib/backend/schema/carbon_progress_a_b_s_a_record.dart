...
class CarbonProgressABSARecord extends FirestoreRecord {
  CarbonProgressABSARecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('CarbonProgressABSA');

  static Stream<CarbonProgressABSARecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => CarbonProgressABSARecord.fromSnapshot(s));

  static Future<CarbonProgressABSARecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => CarbonProgressABSARecord.fromSnapshot(s));

  static CarbonProgressABSARecord fromSnapshot(DocumentSnapshot snapshot) =>
      CarbonProgressABSARecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static CarbonProgressABSARecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      CarbonProgressABSARecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'CarbonProgressABSARecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is CarbonProgressABSARecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createCarbonProgressABSARecordData({
  String? year,
...
class CarbonProgressABSARecordDocumentEquality
    implements Equality<CarbonProgressABSARecord> {
  const CarbonProgressABSARecordDocumentEquality();

  @override
  bool equals(CarbonProgressABSARecord? e1, CarbonProgressABSARecord? e2) {
  ...
  @override
  int hash(CarbonProgressABSARecord? e) => const ListEquality().hash([
        e?.year,
        e?.totalTreesPlanted,
  ...
  @override
  bool isValidKey(Object? o) => o is CarbonProgressABSARecord;
}
